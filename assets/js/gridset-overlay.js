...
gs = {
	...
	show: function () {
		...
		gs.width();
		gs.bind(window, 'resize', function (e) {
			gs.width();
		});
	
	},
	
	unbind : function (t, e, f) {
		
		if (t.removeEvent) t.attachEvent('on' + e, f);
