	...
	<figure>
		<a href="<t4 type="content" name="Section Link" output="linkurl" modifiers="nav_sections"  /><t4 type="content" name="External Link" output="normal" modifiers=""  />">
			<?php if (environment() != "live") { ?>
				<img src="<t4 type="content" name="Media" output="normal" modifiers="" formatter="image/path" />">
			<?php } else { ?>
				<img data-src="http://app.resrc.it/o=80/<?php echo siteURL(); ?><t4 type="content" name="Media" output="normal" modifiers="" formatter="image/path" />" class="rsImg resrc" />
			<?php } ?>
		</a>
	</figure>
	<div class="text">
