...
<li data-tag="<t4 type="navigation" id="4149" />">
  <a class="no-border" href="<t4 type="navigation" id="21"/>" title="">
    ...
    elseif ($media_path != '' && $image_or_video == 'image') { ?>
      <figure><img class="m-hide resrc" data-src="http://app.resrc.it/S=W600/C=W300,H300,XOF50,YOF20/<?php if (environment() == 'live') { echo $siteURL(); } ?><?php echo $media_path; ?>" alt=""></figure>
