...
<!-- Add section name tag -->
    <title>University of the Arts London - University of Arts London</title>    <meta charset='utf-8'>
...
<!-- screen.css -->    
<link rel="stylesheet" type="text/css" media="screen" href="http://ual-beta.s3.amazonaws.com/assets/css/screen.css" />
  ...
  <!-- Home page slider include -->
        ...
        <div class="row slider-container overflow">
          <!--  optional slider heading -->
                    ...
                    <div class="royalSlider rsDefault block full-grid-overflow" data-slider-auto-play="" data-slider-item-width='1280' data-slider-item-height='480'> 
              
<figure>

      
    <img data-src="http://app.resrc.it/http://beta.arts.ac.ukhttp://beta.arts.ac.uk/media/beta/your-creative-journey-starts.jpg" alt="Your Creative Future Starts Here" class="rsImg resrc" />
  ...
  <figcaption class="rsCaption"></figcaption>
    ...
    <img data-src="http://app.resrc.it/http://beta.arts.ac.ukhttp://beta.arts.ac.uk/media/beta/coco.jpg" alt="Coco Chanel as you've never seen her" class="rsImg resrc" />
  ...
  <figcaption class="rsCaption"></figcaption>
    ...
    <img data-src="http://app.resrc.it/http://beta.arts.ac.ukhttp://beta.arts.ac.uk/media/beta/apply-now.jpg" alt="Apply Now" class="rsImg resrc" />
  ...
  <figcaption class="rsCaption"></figcaption>
    ...
    <img data-src="http://app.resrc.it/http://beta.arts.ac.ukhttp://beta.arts.ac.uk/media/beta/this-is-war.jpg" alt="This is war – Syria through the lens of a photojournalism grad" class="rsImg resrc" />
				...
				<ul>
					<li>
						<figure class="feature">
                                                  <a href="" title="Open days at UAL"><img src="http://beta.arts.ac.uk/media/beta/open-days.jpg" alt="Image Alt"></a>
					...
					<li>
						<figure class="feature">
                                                  <a href="" title="Find a course"><img src="http://beta.arts.ac.uk/media/beta/find-a-course.jpg" alt="Image Alt"></a>
							<div class="credits"></div>
						</figure>
		...
		<div class="row news">
			<div class="l-content-full-width block __media four-up-full">
				<ul>
					<li>
						<figure class="feature">
                                                  <a href="" title="Enrol"><img src="http://beta.arts.ac.uk/media/beta/enrol.jpg" alt="Image Alt"></a>
							<div class="credits"></div>
						</figure>
					...
					<li>
						<figure class="feature">
                                                  <a href="" title="Freshers' Festival"><img src="http://beta.arts.ac.uk/media/beta/freshers-festival.jpg" alt="Image Alt"></a>
							<div class="credits"></div>
						</figure>
					...
					<li>
						<figure class="feature">
                                                  <a href="" title="The Art of Business"><img src="http://beta.arts.ac.uk/media/beta/art-of-business.jpg" alt="Image Alt"></a>
							<div class="credits"></div>
						</figure>
					...
					<li>
						<figure class="feature">
                                                  <a href="" title="Spare"><img src="http://beta.arts.ac.uk/media/beta/artsmart.jpg" alt="Image Alt"></a>
							<div class="credits"></div>
						</figure>
		...
		<div class="row fe">
			<div class="l-content-full-width block __media four-up-full">
				...
				<ul>
					...
					<li>
						<figure class="feature">
                                                  <a href="http://newsevents.arts.ac.uk/" title="In conversation: Richard Wilson with curator Jane Won"><img src="http://beta.arts.ac.uk/media/beta/EVENT1-Richard_Wilson_No__Formulas_exhibition.jpg" alt="In conversation: Richard Wilson with curator Jane Won"></a>
						...
						<h3><a href="http://newsevents.arts.ac.uk/" title="In conversation: Richard Wilson with curator Jane Won">In conversation: Richard Wilson with curator Jane Won</a></h3>
							<p>This event accompanies Chelsea Space exhibition: Richard Wilson: No Formulas</p>
					</li>


					<li>
						<figure class="feature">
							<a href="http://newsevents.arts.ac.uk/" title="Future Map Design"><img src="http://beta.arts.ac.uk/media/beta/EVENT2-SimonPhan_LCC_FlowerGirl_01.jpg" alt="Future Map Design"></a>
						...
						<h3><a href="http://newsevents.arts.ac.uk/" title="Future Map Design">Future Map Design</a></h3>
							<p>An exhibition of the best design talent from UAL</p>
					</li>


					<li>
						<figure class="feature">
							<a href="http://newsevents.arts.ac.uk/" title="Dance Umbrella 2013"><img src="http://beta.arts.ac.uk/media/beta/EVENT3-Dance-Umbrella.jpg" alt="Dance Umbrella 2013"></a>
							
						</figure>
						<h3><a href="http://newsevents.arts.ac.uk/" title="Dance Umbrella 2013">Dance Umbrella 2013</a></h3>
							<p>The UK&rsquo;s most vibrant contemporary dance festival returns to the Platform Theatre</p>
					</li>


					<li>
						<figure class="feature">
							<a href="http://newsevents.arts.ac.uk/" title="Mirror Mirror"><img src="http://beta.arts.ac.uk/media/beta/EVENT4-MirrorMirror_Event-image-snapshot.jpg" alt="Mirror Mirror"></a>
						...
						<h3><a href="http://newsevents.arts.ac.uk/" title="Mirror Mirror">Mirror Mirror</a></h3>
							<p>A conference exploring fresh perspectives on age and ageing in relation to culture and fashion</p>
					</li>
		...
		<div class="row st-cp">
			<div class="l-content-full-width block __media two-up-full">
				<ul>
					<li>
						<figure class="feature">
							<a href="http://showtime.arts.ac.uk/" title="Showtime"><img src="http://beta.arts.ac.uk/media/beta/showtime.jpg" alt="Showtime"></a>
					...
					<li>
						<figure class="feature">
							<a href="http://commonplace.arts.ac.uk/" title="Commonplace"><img src="http://beta.arts.ac.uk/media/beta/commonplace.jpg" alt="Commonplace"></a>
...
<!-- Scripts -->
<script type="text/javascript" src="http://ual-beta.s3.amazonaws.com/assets/js/script.js"></script>
