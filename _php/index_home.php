...
<figure>
  ...
  <?php if (environment() != 'live') { ?>
    ...
    <img src="/media/beta/slide-1.jpg" alt="Order a prospectus" class="rsImg" />
...
<figure>
  ...
  <?php if (environment() != 'live') { ?>
    ...
    <img src="/media/beta/slide-2.jpg" alt="Top 10 reasons to study here" class="rsImg" />
...
<figure>
  ...
  <?php if (environment() != 'live') { ?>
    ...
    <img src="/media/beta/slide-3.jpg" alt="Apply now" class="rsImg" />
