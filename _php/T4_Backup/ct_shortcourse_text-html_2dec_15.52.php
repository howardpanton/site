...
$dualcitys=array("LONDONnLiQ", "LONDONojef", "LONDONrIrg", "LONDON2tiT", "LONDONHmk9", "LONDONc3xS", "LONDONK9cN", "ARCHITsUOe", "LONDONbSb1", "LONDONcWkZ", "LONDONjlB4", "LONDONgTgy", "LONDON7wBG", "LONDONJiY8", "LONDONbtei", "LONDONGAPX", "NEWYORPzJ7", "NEWYORES16", "NEWYORzVSu", "FASHIO0vwR", "EXPERI28nF", "VISUALH1Sp", "DUALCIkIH9", "DUALCIiu3F", "DUALCIbMxn", "STANBbuq5", "ISTANBvpOs", "ISTANBFd1l", "LONDONvL39", "LONDONLfs2", "LONDONi3yL", "LONDONDHM8", "LONDONc3xS", "LONDONT98m", "LONDONUUbd", "LONDONHmk9", "LONDON5Ypt", "LONDON6uSN", "LONDONnnkA", "LONDONXlgt", "LONDONoW4g", "LONDONHnhh", "LONDONzvOL", "LONDON14ew", "LONDONUf1F", "NEWYORfgYO", "NEWYORPzJ7", "NEWYORBHZE", "NEWYORLzVz", "NEWYORe7dM", "NEWYORmchk", "NEWYORqmHX");
...
<?php 
  if ($isDualCity) { ?>
    ...
    <p><a class="button-link" style="float:right;" onclick="addToBasket(<?php echo $date["coursedateid"];?>, '<?php echo addslashes($title);?>', '<?php echo $date["startdate"];?> - <?php echo $date["enddate"];?>', '<?php echo $date["starttime"];?> - <?php echo $date["endtime"];?>', '<?php echo round($date["cost"],0);?>', '<?php echo addslashes($venuename[0]['name']); ?>');return false;" href="#">Add to Basket</a> <strong><br><br><br>The total course fee is shown above in two parts due to local tax rules and is inclusive of the cost of tuition. You can only book both sessions together as one course.<br />Please note that accomodation, travel, insurance and living expenses ae not included.</strong></p> 
