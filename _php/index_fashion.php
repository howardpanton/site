...
<!-- Add section name tag -->
    <?php 
	$title = "Illustrator for fashion 2"; 
	if (!empty($title)) {
...
<div class="header-panel bg-gray-bg">
    <div class="header-wrapper">
  <div class="row">
          <!-- navigation object : Breadcrumbs --><div class="breadcrumbs"><a href="/">Beta Home</a><a href="/fashion/courses/">Courses</a><a href="/fashion/courses/short-courses/">Short Courses</a><a href="/fashion/courses/short-courses/browse-short-courses/">Browse Short Courses</a><a href="/fashion/courses/short-courses/browse-short-courses/by-subject/">Courses by subject</a><a href="/fashion/courses/short-courses/browse-short-courses/by-subject/digital-fashion/">Digital fashion</a><a href="/fashion/courses/short-courses/browse-short-courses/by-subject/digital-fashion/illustrator-2/">Illustrator for fashion 2</a></div>
    <div class="page-title">
      <h1><!-- navigation object : Section name -->Illustrator for fashion 2</h1>
    </div>
  </div>  
    </div>
</div>
...
<!--<div class="content-wrapper">
  <div class="row">
    <div class="d5-d16">
      <h1>Illustrator for fashion 2</h1>
    </div>
  </div>
  </div>-->
<!-- Add banner here -->
...
$test = new ShortCourse('ILLUSTD9Rx','');
$r = $test->returnXml();
$title = $test->title();
$t = $test->dates();
...
$xml = @simplexml_load_string(courseDatesCache('ILLUSTD9Rx', ''));
...
?>
	...
	<div class="course-image section-solid-">
        <img  src="/fashion/courses/short-courses/browse-short-courses/by-subject/digital-fashion/illustrator-2/LCF_illustrator_2.jpg"  width="110"  height="110"  alt=""  />
    </div>    
          	<?php 	
} //End of Image
?>
...
$icon_1_type = "twitter"; 
$icon_2_type = "facebook"; 
$icon_3_type = "blog"; 

$icon_1_url = "http://twitter.com/LCFLondon"; 
$icon_2_url = "http://www.facebook.com/LCFOfficial"; 
$icon_3_url = ""; 
...
<footer class="row white-bg hide">
    <div class="footer-wrapper">
        ...
        <ul id="debug">
          ...
          <li>Page created : Thu 15 Aug 2013 10:52:13</li>
          <li>Page modified : Thu 15 Aug 2013 02:02:12</li>
          <?php $i = 0; ?>
          <li>Section id : 44624</li>
      </ul>
        <!-- end debug -->
    </div>
