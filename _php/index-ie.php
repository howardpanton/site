        ...
        if ( !$this->array[$i]['section_link'] == "" ) {
          echo "<a href=\""  . $this->array[$i]['section_link'] . "\"title=\"" . $this->array[$i]['link_title'] . "\">" ;
              ...
              // otherwise, load a resrc'd image
                ...
                echo "<img data-src=\"http://app.resrc.it/" . siteURL() . $this->array[$i]['image'] . "\" alt=\"Image Alt\" class=\"resrc\">";
              }
...
grunticon( [ "http://ual-beta.s3.amazonaws.com/assets/css/logos/logos.data.svg.css", "http://ual-beta.s3.amazonaws.com/assets/css/logos/logos.data.png.css", "http://ual-beta.s3.amazonaws.com/assets/css/logos/logos.fallback.css" ] );
    </script>
  <noscript><link href="http://ual-beta.s3.amazonaws.com/assets/css/logos/logos.fallback.css" rel="stylesheet"></noscript>
  </head>
...
<?php } else { // close the slider ?>        
  ...
  <?php if (environment() != 'live') { ?>
    ...
    <img src="/media/beta/apply-now.jpg" alt="Apply Now" class="rsImg" />

  <?php } else { ?>
    
    <img data-src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/apply-now.jpg" alt="Apply Now" class="rsImg resrc" />
  <?php }
...
<script src="resrc.js"></script> 
<!--<script type="text/javascript" src="/media/beta/beta-assets/js/resrc-0.6.1.min.js"></script>-->

  <!-- fastClick -->
  <script src='http://ual-beta.s3.amazonaws.com/assets/js/fastclick.js' type='text/javascript'></script>
