/*!Updated: 16-07-2014, 12:58:40 PM */
...
(function() {
  this.getEventsFeed = function(programme, type, feed_id, count, keyword, width) {
    var getItemHTML, length, outputfeedHTML;
    if (programme == null) {
    ...
    getItemHTML = function(item) {
      ...
      return itemHTML += '<li> <div class="single-feed-container"> <div class="feed-image"> <a href="' + item.event_url + '"> <span class="center-cropped resrc" style="background-image: url(http://app.resrc.it/s=w250/o=60/' + events_image_url + ');"></span> </a> </div> <div class="title"> <a href="' + item.event_url + '" title="' + item.name + '">' + short_title + '<p class="date">' + ev_date + ', ' + ev_type + '</p> </a> </div> </div> </li>';
    };
    ...
    return $.getJSON(feed_url, function(data) {
      ...
      $.each(data.posts, function(i, item) {
        ...
        if (i < count) {
          ...
          return output += '<li> <div class="feed-image"> <a href="' + item.url + '"> <span class="center-cropped resrc" style="background-image: url(http://app.resrc.it/s=w250/o=60/' + item.attachments[0].url + ');"></span> </a> </div> <div class="title"> <a href="' + item.url + '" title="' + item.title + '">' + short_title + '</a> </div> </li>';
        }
      });
