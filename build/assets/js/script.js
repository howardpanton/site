...
(function() {
  ...
  this.loadMap = function() {
    var bikeLayer, checkboxHTML, closeAllInfoWindows, gJson, i, infoWindow, initialLocation, map, mapDiv, mapOptions, transitLayer, _device_type, _mapCanvas;
    gJson = [];
    initialLocation = {
    ...
    if (_mapCanvas.data("college_checkboxes") === true) {
      ...
      $(".college_filters :checkbox").click(function() {
        var $this, chkbox_id;
        ...
        if ($this.is(":checked")) {
          switch (chkbox_id) {
            case "chk_camb":
              ...
              return camberwellPopup.open(map, markerCamberwell);
            case "chk_csm":
              markerCSM.setVisible(true);
              return csmPopup.open(map, markerCSM);
            case "chk_chelsea":
              markerChelsea.setVisible(true);
              return chelseaPopup.open(map, markerChelsea);
            case "chk_LCC":
              markerLCC.setVisible(true);
              return lccPopup.open(map, markerLCC);
            case "chk_LCF":
              ...
              return markerLCF6.setVisible(true);
            case "chk_wimb":
              markerWimbledon.setVisible(true);
              return wimbPopup.open(map, markerWimbledon);
          }
        } else {
          switch (chkbox_id) {
            case "chk_camb":
              return markerCamberwell.setVisible(false);
            case "chk_csm":
              return markerCSM.setVisible(false);
            case "chk_chelsea":
              return markerChelsea.setVisible(false);
            case "chk_LCC":
              return markerLCC.setVisible(false);
            case "chk_LCF":
              ...
              return markerLCF6.setVisible(false);
            case "chk_wimb":
              return markerWimbledon.setVisible(false);
          }
        }
      });
    }
