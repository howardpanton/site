...
# # Usage: rake prototype name="about.html"
# # You can also specify a sub-directory path.
# # If you don't specify a file extention we create an index.html at the path specified
# desc "Create a new prototype page."
# task :prototype do

#   name = ENV["name"] || "new-prototype.html"
#   title = ENV["title"] || ""
#   college = ENV["college"] || ""
#   author = ENV["author"] || ""
#   filename = File.join(SOURCE, "#{name}")
...
#   open(filename, 'w') do |post|
#     post.puts "---"
#     post.puts "layout: main.tpl"
#     post.puts "title: #{title}"
#     post.puts "college: #{college}"
#     post.puts "created by: #{author}"
#     post.puts "created: #{date}"
#     post.puts "---"
#   end
# end # task :page
